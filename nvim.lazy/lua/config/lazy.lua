...
vim.opt.spelllang = { "en", "es_ES", "ca_ES" }
...
if vim.fn.has("wsl") == 1 then
  vim.g.clipboard = {
    ...
    copy = {
      ["+"] = "/mnt/c/Users/csesmau.INDRA/AppData/Local/Microsoft/WinGet/Packages/equalsraf.win32yank_Microsoft.Winget.Source_8wekyb3d8bbwe/win32yank.exe -i --crlf", -- Command to copy to the system clipboard
      ["*"] = "/mnt/c/Users/csesmau.INDRA/AppData/Local/Microsoft/WinGet/Packages/equalsraf.win32yank_Microsoft.Winget.Source_8wekyb3d8bbwe/win32yank.exe  -i --crlf", -- Command to copy to the primary clipboard
    },
    paste = {
      ["+"] = "/mnt/c/Users/csesmau.INDRA/AppData/Local/Microsoft/WinGet/Packages/equalsraf.win32yank_Microsoft.Winget.Source_8wekyb3d8bbwe/win32yank.exe  -o --lf", -- Command to paste from the system clipboard
      ["*"] = "/mnt/c/Users/csesmau.INDRA/AppData/Local/Microsoft/WinGet/Packages/equalsraf.win32yank_Microsoft.Winget.Source_8wekyb3d8bbwe/win32yank.exe  -o --lf", -- Command to paste from the primary clipboard
    },
